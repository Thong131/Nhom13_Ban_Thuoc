...
namespace GameStore.Areas.Admin.Controllers
{
    public class ChiTietDonHangsController : Controller
    {
        ...
        {
            ViewBag.maDH = new SelectList(db.DonHangs, "maDH", "username");
        ...
        public ActionResult Create([Bind(Include = "id,maDH,maSP,soLuong,tongTien")] ChiTietDonHang chiTietDonHang)
        {
            ...
            ViewBag.maDH = new SelectList(db.DonHangs, "maDH", "username", chiTietDonHang.maDH);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,maDH,maSP,soLuong,tongTien")] ChiTietDonHang chiTietDonHang)
        {
            if (ModelState.IsValid)
            {
