...
namespace GameStore.Areas.Admin.Controllers
{
    public class BinhLuansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaBinhLuan,maSP,MaNguoiDung,NoiDung,NgayBinhLuan")] BinhLuan binhLuan)
        {
            ...
            ViewBag.MaNguoiDung = new SelectList(db.NguoiDungs, "maNguoiDung", "username", binhLuan.MaNguoiDung);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaBinhLuan,maSP,MaNguoiDung,NoiDung,NgayBinhLuan")] BinhLuan binhLuan)
        {
            if (ModelState.IsValid)
            {
